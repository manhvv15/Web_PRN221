...
namespace Web_Triolingo.Pages
{
    public class IndexModel : PageModel
    {
        ...
        public void OnGet(int? id)
        {
            ...
            //{
            //    client_id = "1066312334456024",
            //    redirect_uri = "http://localhost:5199/signin-facebook",
        ...
        //    return View;
        //}
        public IActionResult OnPostFacebook(String code)
        {
            var fb = new FacebookClient();
            ...
            {
                client_id = "1066312334456024",
                client_secret = "784fdf9856e5ab95b4c5af030c4bb712",
                redirect_uri = "http://localhost:5199/signin-facebook",
                code = code
            });
